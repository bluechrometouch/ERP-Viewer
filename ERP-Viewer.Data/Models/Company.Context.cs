...
namespace ERP_Viewer.Data.Models
{
    using System;
    ...
    public partial class CompanyDataEntities : DbContext
    {
        ...
        [DbFunction("CompanyDataEntities", "ufnGetContactInformation")]
        public virtual IQueryable<ufnGetContactInformation_Result> ufnGetContactInformation(Nullable<int> personID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetContactInformation_Result>("[CompanyDataEntities].[ufnGetContactInformation](@PersonID)", personIDParameter);
        }
